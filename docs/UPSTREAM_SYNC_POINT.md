...
| 上游分支 | `master` |
| **最后合并的上游 SHA** | `0ed802c770af2a4bc29d1e92db64caae4b191a99`（2026-08-01） |
| 合并方式 | 选择性 cherry-pick（36 个 dxvk 1.10.3 相关提交）+ 等价内容人工核对 |
| 本地对应分支 | `sync/master-dxvk-1103` → `private/wine-engine-app` |
| 本地对应提交 | `b66318b9e340cd434bd1b3c92e392c5495037f52`（1.1.2 / 1001002） |
| 核对日期 | 2026-08-03 |

## 已核对的上游增量（0ed802c..8089968，共 28 个提交）

- 结论：绝大多数与本地已有工作**等价**（输入/mono/字体/合成阶段等，另一条工作线已同步进上游，本地也有对应实现），**未重复合并**。
